...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('btinfo_bugtracker', 'password', self.gf('healthmeter.fields.PlaintextPasswordField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'BugTracker.password'
        db.alter_column('btinfo_bugtracker', 'password', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
