...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('btinfo_severity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
        db.send_create_signal('btinfo', ['Severity'])

        # Adding field 'Bug.severity'
        db.add_column('btinfo_bug', 'severity',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='bugs', null=True, to=orm['btinfo.Severity']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Severity'
        db.delete_table('btinfo_severity')

        # Deleting field 'Bug.severity'
        db.delete_column('btinfo_bug', 'severity_id')
