...
class Migration(SchemaMigration):
    depends_on = (('hmeter_frontend', '0033_move_btinfo_models_out.py'),)

    def forwards(self, orm):
        # Add unique constraints
        db.create_unique('btinfo_bugnamespace', ['product', 'component',
                                                      'project_id',
                                                      'bug_tracker_id'])
        db.create_unique('btinfo_bug', ['tracker_info_id', 'bug_id'])
        db.create_unique('btinfo_comment', ['bug_id', 'comment_id'])


    def backwards(self, orm):
        # Remove unique constraints
        db.delete_unique('btinfo_comment', ['bug_id', 'comment_id'])
        db.delete_unique('btinfo_bug', ['tracker_info_id', 'bug_id'])
        db.delete_unique('btinfo_bugnamespace', ['product', 'component',
                                                      'project_id',
                                                      'bug_tracker_id'])
    ...
    models = {
        ...
        'btinfo.bugtracker': {
            ...
            'projects': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['projectinfo.Project']", 'through': "orm['btinfo.BugNamespace']", 'symmetrical': 'False'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        'btinfo.bugnamespace': {
            'Meta': {'unique_together': "(('product', 'component', 'project', 'bug_tracker'),)", 'object_name': 'BugNamespace'},
            'bug_tracker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['btinfo.BugTracker']"}),
