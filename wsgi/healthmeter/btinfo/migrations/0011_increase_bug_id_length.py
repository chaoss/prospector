...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bug.bug_id'
        db.alter_column('btinfo_bug', 'bug_id', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Bug.bug_id'
        db.alter_column('btinfo_bug', 'bug_id', self.gf('django.db.models.fields.CharField')(max_length=10))
