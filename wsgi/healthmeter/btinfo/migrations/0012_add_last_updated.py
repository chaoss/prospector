...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BugNamespace.last_updated'
        db.add_column('btinfo_bugnamespace', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BugNamespace.last_updated'
        db.delete_column('btinfo_bugnamespace', 'last_updated')
