...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Type', fields ['name']
        db.create_unique('btinfo_type', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Type', fields ['name']
        db.delete_unique('btinfo_type', ['name'])
