...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Query.project'
        db.add_column(u'gtrendsinfo_query', 'project',
                      self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Query.project'
        db.delete_column(u'gtrendsinfo_query', 'project_id')


    models = {
        u'gtrendsinfo.credential': {
        ...
        u'gtrendsinfo.datapoint': {
            'Meta': {'unique_together': "(('keyword', 'start', 'end'),)", 'object_name': 'DataPoint'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'end': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'keyword': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'datapoints'", 'to': u"orm['gtrendsinfo.Query']"}),
