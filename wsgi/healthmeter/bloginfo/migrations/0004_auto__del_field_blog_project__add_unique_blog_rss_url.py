...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'bloginfo_blog', 'project_id')

        # Adding unique constraint on 'Blog', fields ['rss_url']
        db.create_unique(u'bloginfo_blog', ['rss_url'])


    def backwards(self, orm):
        # Removing unique constraint on 'Blog', fields ['rss_url']
        db.delete_unique(u'bloginfo_blog', ['rss_url'])

        # Adding field 'Blog.project'
        db.add_column(u'bloginfo_blog', 'project',
