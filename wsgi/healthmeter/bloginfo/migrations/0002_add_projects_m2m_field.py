...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field projects on 'Blog'
        db.create_table(u'bloginfo_blog_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm[u'bloginfo.blog'], null=False)),
            ('project', models.ForeignKey(orm[u'projectinfo.project'], null=False))
        ))
        db.create_unique(u'bloginfo_blog_projects', ['blog_id', 'project_id'])


        # Changing field 'Blog.project'
        db.alter_column(u'bloginfo_blog', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project'], null=True))

    def backwards(self, orm):
        # Removing M2M table for field projects on 'Blog'
        db.delete_table('bloginfo_blog_projects')


        # Changing field 'Blog.project'
        db.alter_column(u'bloginfo_blog', 'project_id', self.gf('mptt.fields.TreeForeignKey')(default=None, to=orm['projectinfo.Project']))
