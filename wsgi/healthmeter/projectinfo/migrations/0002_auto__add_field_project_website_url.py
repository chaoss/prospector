...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.website_url'
        db.add_column('projectinfo_project', 'website_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.website_url'
        db.delete_column('projectinfo_project', 'website_url')
