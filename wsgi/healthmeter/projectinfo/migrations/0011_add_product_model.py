...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projectinfo_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('business_unit', self.gf('django.db.models.fields.related.ForeignKey')(related_name='products', to=orm['projectinfo.BusinessUnit'])),
        ))
        db.send_create_signal(u'projectinfo', ['Product'])


    def backwards(self, orm):
        # Deleting model 'Product'
        db.delete_table(u'projectinfo_product')
