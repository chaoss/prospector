...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'vcsinfo_repository', 'project',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='repositories', null=True, to=orm['projectinfo.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.project'
        db.delete_column(u'vcsinfo_repository', 'project_id')
