...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('vcsinfo_commit', 'author_id')
        db.rename_column('vcsinfo_commit', 'author_new_id', 'author_id')

        # Changing field 'Commit.author'
        db.alter_column('vcsinfo_commit', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['vcsinfo.Committer']))

    def backwards(self, orm):
        # Changing field 'Commit.author'
        db.alter_column('vcsinfo_commit', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vcsinfo.Committer']))

        db.rename_column('vcsinfo_commit', 'author_id', 'author_new_id')

        # Adding field 'Commit.author_new'
        db.add_column('vcsinfo_commit', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='commits', null=True, to=orm['participantinfo.Participant']),
                      keep_default=False)
