...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Repository.project'
        db.rename_column('vcsinfo_repository', 'project_id', 'project_old_id')

    def backwards(self, orm):
        # Deleting field 'Repository.project_old'
        db.rename_column('vcsinfo_repository', 'project_old_id', 'project_id')
