...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Branch.repository'
        db.alter_column(u'vcsinfo_branch', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vcsinfo.Repository']))
        # Adding unique constraint on 'Branch', fields ['name', 'repository']
        db.create_unique(u'vcsinfo_branch', ['name', 'repository_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Branch', fields ['name', 'repository']
        db.delete_unique(u'vcsinfo_branch', ['name', 'repository_id'])


        # Changing field 'Branch.repository'
        db.alter_column(u'vcsinfo_branch', 'repository_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['vcsinfo.Repository']))
    ...
    models = {
        ...
        u'vcsinfo.branch': {
            'Meta': {'unique_together': "(('name', 'repository'),)", 'object_name': 'Branch'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_main': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'latest_commit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'branches'", 'to': u"orm['vcsinfo.Commit']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'repository': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'branches'", 'to': u"orm['vcsinfo.Repository']"})
        },
        u'vcsinfo.commit': {
