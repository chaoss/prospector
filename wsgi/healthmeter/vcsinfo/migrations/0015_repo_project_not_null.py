...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Repository.project'
        db.alter_column(u'vcsinfo_repository', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project']))

    def backwards(self, orm):

        # Changing field 'Repository.project'
        db.alter_column(u'vcsinfo_repository', 'project_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['projectinfo.Project']))
