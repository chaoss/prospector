...
class Migration(SchemaMigration):
    depends_on = (
        ('hmeter_frontend', '0028_copy_project_field.py'),
    )

    def forwards(self, orm):
        # Deleting field 'Repository.project_old'
        db.delete_column('vcsinfo_repository', 'project_old_id')


    def backwards(self, orm):
        # Adding field 'Repository.project_old'
        dummy_project_id = orm['projectinfo.Project'].objects.all()[0].pk
        db.add_column('vcsinfo_repository', 'project_old',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=dummy_project_id, related_name='vcs_repositories', to=orm['projectinfo.Project']),
                      keep_default=False)
