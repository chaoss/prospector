...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'GTrendsQuery.project'
        db.rename_column(u'hmeter_frontend_gtrendsquery', 'project_id',
                         'project_old_id')

    def backwards(self, orm):
        # Renaming field 'GTrendsQuery.project'
        db.rename_column(u'hmeter_frontend_gtrendsquery', 'project_old_id',
                         'project_id')
