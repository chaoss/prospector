...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IrcLogin'
        db.create_table('healthmeter_irclogin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='irc_logins', to=orm['healthmeter.Participant'])),
            ('nickname', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.IrcServer'])),
        ))
        db.send_create_signal('hmeter_frontend', ['IrcLogin'])

        # Adding unique constraint on 'IrcLogin', fields ['nickname', 'server']
        db.create_unique('healthmeter_irclogin', ['nickname', 'server_id'])

        # Adding model 'IrcMeeting'
        db.create_table('healthmeter_ircmeeting', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='meetings', to=orm['healthmeter.IrcChannel'])),
        ...
        # Adding model 'IrcServer'
        db.create_table('healthmeter_ircserver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.create_table('healthmeter_ircchannel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(related_name='channels', unique=True, to=orm['healthmeter.IrcServer'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('meeting_logs_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('hmeter_frontend', ['IrcChannel'])

        # Adding M2M table for field projects on 'IrcChannel'
        db.create_table('healthmeter_ircchannel_projects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ircchannel', models.ForeignKey(orm['healthmeter.ircchannel'], null=False)),
            ('project', models.ForeignKey(orm['healthmeter.project'], null=False))
        ))
        db.create_unique('healthmeter_ircchannel_projects', ['ircchannel_id', 'project_id'])

        # Adding model 'IrcMessage'
        db.create_table('healthmeter_ircmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.IrcLogin'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('channel', self.gf('django.db.models.fields.related.ForeignKey')(related_name='msesages', to=orm['healthmeter.IrcChannel'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'IrcLogin', fields ['nickname', 'server']
        db.delete_unique('healthmeter_irclogin', ['nickname', 'server_id'])

        # Deleting model 'IrcLogin'
        db.delete_table('healthmeter_irclogin')

        # Deleting model 'IrcMeeting'
        db.delete_table('healthmeter_ircmeeting')

        # Deleting model 'IrcServer'
        db.delete_table('healthmeter_ircserver')

        # Deleting model 'IrcChannel'
        db.delete_table('healthmeter_ircchannel')

        # Removing M2M table for field projects on 'IrcChannel'
        db.delete_table('healthmeter_ircchannel_projects')

        # Deleting model 'IrcMessage'
        db.delete_table('healthmeter_ircmessage')
    ...
    models = {
        ...
        'healthmeter.ircmeeting': {
            'Meta': {'ordering': "['time_start']", 'object_name': 'IrcMeeting'},
        ...
        'healthmeter.ircmessage': {
            ...
            'channel': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'msesages'", 'to': "orm['healthmeter.IrcChannel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {})
        },
