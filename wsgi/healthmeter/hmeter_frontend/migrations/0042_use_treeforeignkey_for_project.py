...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('hmeter_frontend_blog', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project']))

        # Changing field 'MailingListProject.project'
        db.alter_column('hmeter_frontend_mailinglistproject', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project']))

        # Changing field 'VCSRepository.project'
        db.alter_column('hmeter_frontend_vcsrepository', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project']))

        # Changing field 'CPEProduct.project'
        db.alter_column('hmeter_frontend_cpeproduct', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project']))

        # Changing field 'Event.project'
        db.alter_column('hmeter_frontend_event', 'project_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CPEProduct.project'
        db.alter_column('hmeter_frontend_cpeproduct', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projectinfo.Project']))
