...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'CPEProduct'
        db.delete_table(u'hmeter_frontend_cpeproduct')


    def backwards(self, orm):
        # Adding model 'CPEProduct'
        db.create_table(u'hmeter_frontend_cpeproduct', (
            ('project_old', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project'])),
            (u'product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cveinfo.Product'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'hmeter_frontend', ['CPEProduct'])
