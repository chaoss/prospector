...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metric.time_based'
        db.add_column(u'hmeter_frontend_metric', 'time_based',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metric.time_based'
        db.delete_column(u'hmeter_frontend_metric', 'time_based')
