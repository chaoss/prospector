...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        # Re-create derived instances of BugNamespace
        for basebn in orm['btinfo.BugNamespace'].objects.filter(
                bugnamespace__isnull=True):
            bn = orm['hmeter_frontend.BugNamespace'](
                bugnamespace_ptr_id=basebn)
            bn.__dict__.update(basebn.__dict__)
            bn.save()
