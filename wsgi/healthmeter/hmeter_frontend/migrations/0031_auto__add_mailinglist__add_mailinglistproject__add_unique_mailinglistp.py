...
class Migration(SchemaMigration):
    depends_on = (('mlinfo', '0001_initial.py'),)

    def forwards(self, orm):
        # Adding model 'MailingList'
        db.create_table('hmeter_frontend_mailinglist', (
            ('mailinglist_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mlinfo.MailingList'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('hmeter_frontend', ['MailingList'])

        # Adding model 'MailingListProject'
        db.create_table('hmeter_frontend_mailinglistproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mailing_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmeter_frontend.MailingList'])),
        ...
        db.create_unique('hmeter_frontend_mailinglistproject', ['project_id', 'purpose_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'MailingListProject', fields ['project', 'purpose']
        db.delete_unique('hmeter_frontend_mailinglistproject', ['project_id', 'purpose_id'])

        # Deleting model 'MailingList'
        db.delete_table('hmeter_frontend_mailinglist')

        # Deleting model 'MailingListProject'
        db.delete_table('hmeter_frontend_mailinglistproject')
    ...
    models = {
        ...
        'mlinfo.mailinglistproject': {
            'Meta': {'ordering': "('project__name',)", 'unique_together': "(('project', 'purpose'),)", 'object_name': 'MailingListProject'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mailing_list': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_mailinglistproject_set'", 'to': "orm['mlinfo.MailingList']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_mailinglistproject_set'", 'to': "orm['projectinfo.Project']"}),
            'purpose': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'old_mailinglistproject_set'", 'to': "orm['mlinfo.Purpose']"})
        },
        'mlinfo.purpose': {
