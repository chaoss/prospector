...
class Migration(SchemaMigration):
    """
    Dummy migration to re-freeze the models with an explicit
    BugNamespace_Projects through model for BugNamespace <---> Project M2M
    relation.
    """
    ...
    models = {
        ...
        u'hmeter_frontend.bugnamespace': {
            ...
            'projects': ('mptt.fields.TreeManyToManyField', [], {'related_name': "'bug_trackers'", 'symmetrical': 'False', 'through': u"orm['hmeter_frontend.BugNamespace_Projects']", 'to': u"orm['projectinfo.Project']"})
        },
        u'hmeter_frontend.bugnamespace_projects': {
            'Meta': {'unique_together': "(('bugnamespace', 'project'),)", 'object_name': 'BugNamespace_Projects'},
            'bugnamespace': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hmeter_frontend.BugNamespace']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
