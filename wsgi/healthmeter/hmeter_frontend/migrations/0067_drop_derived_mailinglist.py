...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'hmeter_frontend_mailinglist')


    def backwards(self, orm):
        # Adding model 'MailingList'
        db.create_table(u'hmeter_frontend_mailinglist', (
            (u'mailinglist_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['mlinfo.MailingList'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'hmeter_frontend', ['MailingList'])
