...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MailingListProject.mailing_list'
        db.alter_column(u'hmeter_frontend_mailinglistproject', 'mailing_list_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mlinfo.MailingList']))

    def backwards(self, orm):

        # Changing field 'MailingListProject.mailing_list'
        db.alter_column(u'hmeter_frontend_mailinglistproject', 'mailing_list_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmeter_frontend.MailingList']))
