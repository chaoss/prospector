...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metric.template_name'
        db.add_column('hmeter_frontend_metric', 'template_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metric.template_name'
        db.delete_column('hmeter_frontend_metric', 'template_name')
