...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for repo in orm['vcsinfo.Repository'].objects \
                .filter(vcsrepository=None):
            newrepo = orm['hmeter_frontend.VCSRepository'](
                repository_ptr_id=repo, project=repo.project_old)
            newrepo.__dict__.update(repo.__dict__)
            newrepo.save()
