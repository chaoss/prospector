...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bug.close_date'
        db.add_column('healthmeter_bug', 'close_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bug.close_date'
        db.delete_column('healthmeter_bug', 'close_date')
