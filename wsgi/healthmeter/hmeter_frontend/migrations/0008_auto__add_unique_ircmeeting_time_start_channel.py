...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'IrcMeeting', fields ['time_start', 'channel']
        db.create_unique('healthmeter_ircmeeting', ['time_start', 'channel_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'IrcMeeting', fields ['time_start', 'channel']
        db.delete_unique('healthmeter_ircmeeting', ['time_start', 'channel_id'])
