...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Metric.description'
        db.alter_column('hmeter_frontend_metric', 'description', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Metric.description'
        db.alter_column('hmeter_frontend_metric', 'description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))
