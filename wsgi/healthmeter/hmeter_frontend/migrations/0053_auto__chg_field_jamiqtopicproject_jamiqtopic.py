...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JamiqTopicProject.jamiqtopic'
        db.alter_column('hmeter_frontend_jamiqtopic_projects', 'jamiqtopic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['jamiqinfo.Topic']))

    def backwards(self, orm):

        # Changing field 'JamiqTopicProject.jamiqtopic'
        db.alter_column('hmeter_frontend_jamiqtopic_projects', 'jamiqtopic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmeter_frontend.JamiqTopic']))
    ...
    models = {
        ...
        'hmeter_frontend.jamiqtopicproject': {
            'Meta': {'object_name': 'JamiqTopicProject', 'db_table': "'hmeter_frontend_jamiqtopic_projects'", 'unique_together': "(('jamiqtopic', 'project'),)"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jamiqtopic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['jamiqinfo.Topic']"}),
            'project': ('mptt.fields.TreeForeignKey', [], {'to': "orm['projectinfo.Project']"})
        },
        ...
        'projectinfo.project': {
            ...
            'business_unit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'projects'", 'null': 'True', 'to': "orm['projectinfo.BusinessUnit']"}),
