...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'hmeter_frontend_bugnamespace')


    def backwards(self, orm):
        # Adding model 'BugNamespace'
        db.create_table(u'hmeter_frontend_bugnamespace', (
            (u'bugnamespace_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['btinfo.BugNamespace'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'hmeter_frontend', ['BugNamespace'])
