...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Nothing to do here. MailingList will be dropped in the next migration
        pass

    def backwards(self, orm):
        # Re-create derived MailingList instances
        for baseml in orm['mlinfo.MailingList'].objects.all():
            ml = orm['hmeter_frontend.MailingList'](mailinglist_ptr_id=baseml)
            ml.__dict__.update(baseml.__dict__)
            ml.save()
