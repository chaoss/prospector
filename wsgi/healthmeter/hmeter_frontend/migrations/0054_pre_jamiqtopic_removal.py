...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Nothing to do here. We're going to remove the table
        pass

    def backwards(self, orm):
        "Write your backwards methods here."
        # Restore JamiqTopic instances
        for i in orm['jamiqinfo.Topic'].objects.all():
            newtopic = orm['hmeter_frontend.JamiqTopic'](topic_ptr_id=i)
            newtopic.__dict__.update(i.__dict__)
            newtopic.save()
