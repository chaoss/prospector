...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('healthmeter_blogpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('blog', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.Blog'])),
        ...
        # Adding model 'Blog'
        db.create_table('healthmeter_blog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rss_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('healthmeter_blogpost')

        # Deleting model 'Blog'
        db.delete_table('healthmeter_blog')
