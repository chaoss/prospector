...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GTrendsQuery'
        db.delete_table(u'hmeter_frontend_gtrendsquery')


    def backwards(self, orm):
        # Adding model 'GTrendsQuery'
        db.create_table(u'hmeter_frontend_gtrendsquery', (
            ('project_old', self.gf('mptt.fields.TreeForeignKey')(related_name='gtrends_queries', to=orm['projectinfo.Project'])),
            (u'query_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['gtrendsinfo.Query'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'hmeter_frontend', ['GTrendsQuery'])
