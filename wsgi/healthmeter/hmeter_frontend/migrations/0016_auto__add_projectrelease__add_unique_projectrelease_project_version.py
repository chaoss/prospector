...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('healthmeter_projectrelease', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='releases', to=orm['healthmeter.Project'])),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('hmeter_frontend', ['ProjectRelease'])

        # Adding unique constraint on 'ProjectRelease', fields ['project', 'version']
        db.create_unique('healthmeter_projectrelease', ['project_id', 'version'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProjectRelease', fields ['project', 'version']
        db.delete_unique('healthmeter_projectrelease', ['project_id', 'version'])

        # Deleting model 'ProjectRelease'
        db.delete_table('healthmeter_projectrelease')
