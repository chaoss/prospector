...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IrcChannel.meeting_logs_url'
        db.alter_column('healthmeter_ircchannel', 'meeting_logs_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'IrcChannel.meeting_logs_url'
        db.alter_column('healthmeter_ircchannel', 'meeting_logs_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
