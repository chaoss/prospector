...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'hmeter_frontend.jamiqtopic': {
            ...
            'projects': ('mptt.fields.TreeManyToManyField', [], {'related_name': "'jamiq_topics'", 'symmetrical': 'False', 'through': "orm['hmeter_frontend.JamiqTopicProject']", 'to': "orm['projectinfo.Project']"}),
        ...
        'hmeter_frontend.jamiqtopicproject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jamiqtopic': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hmeter_frontend.JamiqTopic']"}),
            'project': ('mptt.fields.TreeForeignKey', [], {'to': "orm['projectinfo.Project']"})
        },
