...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'hmeter_frontend_vcsrepository')


    def backwards(self, orm):
        # Adding model 'VCSRepository'
        db.create_table(u'hmeter_frontend_vcsrepository', (
            (u'repository_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vcsinfo.Repository'], unique=True, primary_key=True)),
            ('project_old', self.gf('mptt.fields.TreeForeignKey')(related_name='vcs_repositories', to=orm['projectinfo.Project'])),
        ))
        db.send_create_signal(u'hmeter_frontend', ['VCSRepository'])
