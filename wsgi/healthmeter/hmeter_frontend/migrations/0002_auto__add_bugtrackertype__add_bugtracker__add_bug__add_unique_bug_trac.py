...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BugTrackerType'
        db.create_table('healthmeter_bugtrackertype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('hmeter_frontend', ['BugTrackerType'])

        # Adding model 'BugTracker'
        db.create_table('healthmeter_bugtracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('baseurl', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('bt_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.BugTrackerType'])),
            ('username', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('password', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('hmeter_frontend', ['BugTracker'])

        # Adding model 'Bug'
        db.create_table('healthmeter_bug', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tracker_info', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bugs', to=orm['healthmeter.BugTrackerProject'])),
            ('bug_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('hmeter_frontend', ['Bug'])

        # Adding unique constraint on 'Bug', fields ['tracker_info', 'bug_id']
        db.create_unique('healthmeter_bug', ['tracker_info_id', 'bug_id'])

        # Adding model 'BugTrackerProject'
        db.create_table('healthmeter_bugtrackerproject', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bug_tracker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.BugTracker'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.Project'], unique=True)),
            ('product', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('component', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('hmeter_frontend', ['BugTrackerProject'])

        # Adding unique constraint on 'BugTrackerProject', fields ['project', 'product', 'component']
        db.create_unique('healthmeter_bugtrackerproject', ['project_id', 'product', 'component'])

        # Adding model 'BugComment'
        db.create_table('healthmeter_bugcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bug', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['healthmeter.Bug'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.Bug'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('comment_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('hmeter_frontend', ['BugComment'])

        # Adding unique constraint on 'BugComment', fields ['bug', 'comment_id']
        db.create_unique('healthmeter_bugcomment', ['bug_id', 'comment_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BugComment', fields ['bug', 'comment_id']
        db.delete_unique('healthmeter_bugcomment', ['bug_id', 'comment_id'])

        # Removing unique constraint on 'BugTrackerProject', fields ['project', 'product', 'component']
        db.delete_unique('healthmeter_bugtrackerproject', ['project_id', 'product', 'component'])

        # Removing unique constraint on 'Bug', fields ['tracker_info', 'bug_id']
        db.delete_unique('healthmeter_bug', ['tracker_info_id', 'bug_id'])

        # Deleting model 'BugTrackerType'
        db.delete_table('healthmeter_bugtrackertype')

        # Deleting model 'BugTracker'
        db.delete_table('healthmeter_bugtracker')

        # Deleting model 'Bug'
        db.delete_table('healthmeter_bug')

        # Deleting model 'BugTrackerProject'
        db.delete_table('healthmeter_bugtrackerproject')

        # Deleting model 'BugComment'
        db.delete_table('healthmeter_bugcomment')
