...
class Migration(SchemaMigration):
    renamed_tables = ('participant', 'emaildomain', 'participantemail',
                      'project', 'projectrelease', 'vcstype', 'vcsrepository',
                      'vcscommit', 'mailinglistpurpose', 'mailinglist',
                      'mailinglistproject', 'mailinglistpost',
                      'mailinglistpost_references',
                      'mailinglistpost_mailing_lists', 'bugtrackertype',
                      'bugtracker', 'bugtrackerproject', 'bug', 'bugcomment',
                      'ircserver', 'irclogin', 'ircchannel',
                      'ircchannel_projects', 'ircmeeting', 'ircmessage',
                      'event', 'blog', 'blogpost')

    def forwards(self, orm):
        for table in self.renamed_tables:
            db.rename_table('healthmeter_%s' % table,
                            'hmeter_frontend_%s' % table)

    def backwards(self, orm):
        for table in self.renamed_tables:
            db.rename_table('hmeter_frontend_%s' % table,
                            'healthmeter_%s' % table)

    models = {
        'hmeter_frontend.blog': {
            'Meta': {'object_name': 'Blog', 'db_table': "'healthmeter_blog'"},
        ...
        'hmeter_frontend.blogpost': {
            'Meta': {'object_name': 'BlogPost', 'db_table': "'healthmeter_blogpost'"},
        ...
        'hmeter_frontend.bug': {
            'Meta': {'unique_together': "(('tracker_info', 'bug_id'),)", 'object_name': 'Bug', 'db_table': "'healthmeter_bug'"},
        ...
        'hmeter_frontend.bugcomment': {
            'Meta': {'unique_together': "(('bug', 'comment_id'),)", 'object_name': 'BugComment', 'db_table': "'healthmeter_bugcomment'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hmeter_frontend.Participant']"}),
        ...
        'hmeter_frontend.bugtracker': {
            'Meta': {'object_name': 'BugTracker', 'db_table': "'healthmeter_bugtracker'"},
        ...
        'hmeter_frontend.bugtrackerproject': {
            'Meta': {'unique_together': "(('product', 'component', 'project', 'bug_tracker'),)", 'object_name': 'BugTrackerProject', 'db_table': "'healthmeter_bugtrackerproject'"},
        ...
        'hmeter_frontend.bugtrackertype': {
            'Meta': {'object_name': 'BugTrackerType', 'db_table': "'healthmeter_bugtrackertype'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '10'})
        },
        'hmeter_frontend.emaildomain': {
            'Meta': {'object_name': 'EmailDomain', 'db_table': "'healthmeter_emaildomain'"},
            'domain': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'hmeter_frontend.event': {
            'Meta': {'object_name': 'Event', 'db_table': "'healthmeter_event'"},
        ...
        'hmeter_frontend.ircchannel': {
            'Meta': {'unique_together': "(('server', 'name'),)", 'object_name': 'IrcChannel', 'db_table': "'healthmeter_ircchannel'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hmeter_frontend.irclogin': {
            'Meta': {'unique_together': "(('nickname', 'server'),)", 'object_name': 'IrcLogin', 'db_table': "'healthmeter_irclogin'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hmeter_frontend.ircmeeting': {
            'Meta': {'ordering': "['time_start']", 'unique_together': "(('channel', 'time_start'),)", 'object_name': 'IrcMeeting', 'db_table': "'healthmeter_ircmeeting'"},
        ...
        'hmeter_frontend.ircmessage': {
            'Meta': {'object_name': 'IrcMessage', 'db_table': "'healthmeter_ircmessage'"},
        ...
        'hmeter_frontend.ircserver': {
            'Meta': {'object_name': 'IrcServer', 'db_table': "'healthmeter_ircserver'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'server_url': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'hmeter_frontend.mailinglist': {
            'Meta': {'object_name': 'MailingList', 'db_table': "'healthmeter_mailinglist'"},
        ...
        'hmeter_frontend.mailinglistpost': {
            'Meta': {'object_name': 'MailingListPost', 'db_table': "'healthmeter_mailinglistpost'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hmeter_frontend.Participant']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hmeter_frontend.mailinglistproject': {
            'Meta': {'ordering': "('project__name',)", 'unique_together': "(('project', 'purpose'),)", 'object_name': 'MailingListProject', 'db_table': "'healthmeter_mailinglistproject'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'hmeter_frontend.mailinglistpurpose': {
            'Meta': {'object_name': 'MailingListPurpose', 'db_table': "'healthmeter_mailinglistpurpose'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'hmeter_frontend.participant': {
            'Meta': {'object_name': 'Participant', 'db_table': "'healthmeter_participant'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        'hmeter_frontend.participantemail': {
            'Meta': {'object_name': 'ParticipantEmail', 'db_table': "'healthmeter_participantemail'"},
        ...
        'hmeter_frontend.projectrelease': {
            'Meta': {'ordering': "('date', 'version')", 'unique_together': "(('project', 'version'),)", 'object_name': 'ProjectRelease', 'db_table': "'healthmeter_projectrelease'"},
        ...
        'hmeter_frontend.vcscommit': {
            'Meta': {'unique_together': "(('repository', 'commit_id'),)", 'object_name': 'VCSCommit', 'db_table': "'healthmeter_vcscommit'"},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hmeter_frontend.Participant']"}),
        ...
        'hmeter_frontend.vcsrepository': {
            'Meta': {'object_name': 'VCSRepository', 'db_table': "'healthmeter_vcsrepository'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hmeter_frontend.Project']"}),
        ...
        'hmeter_frontend.vcstype': {
            'Meta': {'object_name': 'VCSType', 'db_table': "'healthmeter_vcstype'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
