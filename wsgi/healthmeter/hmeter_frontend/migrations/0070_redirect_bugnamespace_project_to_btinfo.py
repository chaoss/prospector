...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BugNamespace_Projects.bugnamespace'
        db.alter_column(u'hmeter_frontend_bugnamespace_projects', 'bugnamespace_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['btinfo.BugNamespace']))

    def backwards(self, orm):

        # Changing field 'BugNamespace_Projects.bugnamespace'
        db.alter_column(u'hmeter_frontend_bugnamespace_projects', 'bugnamespace_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmeter_frontend.BugNamespace']))
    ...
    models = {
        ...
        u'hmeter_frontend.bugnamespace_projects': {
            'Meta': {'unique_together': "(('bugnamespace', 'project'),)", 'object_name': 'BugNamespace_Projects'},
            'bugnamespace': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['btinfo.BugNamespace']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projectinfo.Project']"})
        },
