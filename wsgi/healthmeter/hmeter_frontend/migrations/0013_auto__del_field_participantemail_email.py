...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ParticipantEmail.email'
        db.delete_column('healthmeter_participantemail', 'email')


    def backwards(self, orm):
        
        # Adding field 'ParticipantEmail.email'
        db.add_column('healthmeter_participantemail', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)
