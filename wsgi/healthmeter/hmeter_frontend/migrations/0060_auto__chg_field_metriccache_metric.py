...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MetricCache.metric'
        db.alter_column(u'hmeter_frontend_metriccache', 'metric_id', self.gf('mptt.fields.TreeForeignKey')(to=orm['hmeter_frontend.Metric']))

    def backwards(self, orm):

        # Changing field 'MetricCache.metric'
        db.alter_column(u'hmeter_frontend_metriccache', 'metric_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmeter_frontend.Metric']))
