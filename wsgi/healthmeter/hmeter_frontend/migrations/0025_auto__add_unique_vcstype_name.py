...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'VCSType', fields ['name']
        db.create_unique('hmeter_frontend_vcstype', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'VCSType', fields ['name']
        db.delete_unique('hmeter_frontend_vcstype', ['name'])
