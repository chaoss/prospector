...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('healthmeter_bugcomment', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.Participant']))


    def backwards(self, orm):
        
        # Changing field 'BugComment.author'
        db.alter_column('healthmeter_bugcomment', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['healthmeter.Bug']))
