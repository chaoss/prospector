...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.governance'
        db.add_column('healthmeter_project', 'governance', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'Project.license'
        db.add_column('healthmeter_project', 'license', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.governance'
        db.delete_column('healthmeter_project', 'governance')

        # Deleting field 'Project.license'
        db.delete_column('healthmeter_project', 'license')
