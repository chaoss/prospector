...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'MailingListProject', fields ['project', 'mailing_list']
        db.create_unique('hmeter_frontend_mailinglistproject', ['project_id', 'mailing_list_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MailingListProject', fields ['project', 'mailing_list']
        db.delete_unique('hmeter_frontend_mailinglistproject', ['project_id', 'mailing_list_id'])
    ...
    models = {
        ...
        'hmeter_frontend.jamiqtopicproject': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jamiqtopic': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'jtp'", 'to': "orm['jamiqinfo.Topic']"}),
            'project': ('mptt.fields.TreeForeignKey', [], {'related_name': "'jtp'", 'to': "orm['projectinfo.Project']"})
        },
