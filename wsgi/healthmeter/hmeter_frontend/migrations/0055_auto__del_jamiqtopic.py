...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming table for JamiqTopicProject
        db.rename_table('hmeter_frontend_jamiqtopic_projects',
                        'hmeter_frontend_jamiqtopicproject')
    ...
    def backwards(self, orm):
        ...
        db.rename_table('hmeter_frontend_jamiqtopicproject',
                        'hmeter_frontend_jamiqtopic_projects')
