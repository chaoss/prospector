...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MetricCache'
        db.create_table(u'hmeter_frontend_metriccache', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('mptt.fields.TreeForeignKey')(to=orm['projectinfo.Project'])),
            ('metric', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hmeter_frontend.Metric'])),
            ('raw_value', self.gf('jsonfield.fields.JSONField')(null=True)),
        ...
        db.send_create_signal(u'hmeter_frontend', ['MetricCache'])

        # Adding unique constraint on 'MetricCache', fields ['project', 'metric', 'start', 'end']
        db.create_unique(u'hmeter_frontend_metriccache', ['project_id', 'metric_id', 'start', 'end'])


    def backwards(self, orm):
        # Removing unique constraint on 'MetricCache', fields ['project', 'metric', 'start', 'end']
        db.delete_unique(u'hmeter_frontend_metriccache', ['project_id', 'metric_id', 'start', 'end'])

        # Deleting model 'MetricCache'
        db.delete_table(u'hmeter_frontend_metriccache')
    ...
    models = {
        ...
        u'hmeter_frontend.metriccache': {
            ...
            'metric': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['hmeter_frontend.Metric']"}),
            'project': ('mptt.fields.TreeForeignKey', [], {'to': u"orm['projectinfo.Project']"}),
        ...
        u'hmeter_frontend.vcsrepository': {
            ...
            'project': ('mptt.fields.TreeForeignKey', [], {'related_name': "'vcs_repositories'", 'to': u"orm['projectinfo.Project']"}),
