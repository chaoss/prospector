...
class Migration(SchemaMigration):
    depends_on = (
        ('mlinfo', '0002_auto__del_mailinglistproject__del_unique_mailinglistproject_project_pu.py'),
    )

    def forwards(self, orm):
        # Removing unique constraint on 'MailingListProject', fields
        # ['project', 'mailing_list']
        db.delete_unique(u'hmeter_frontend_mailinglistproject',
                         ['project_id', 'mailing_list_id'])

        # Renaming model 'MailingListProject'
        db.rename_table(u'hmeter_frontend_mailinglistproject',
                        u'mlinfo_mailinglistproject')
        db.send_create_signal(u'mlinfo', ['MailingListProject'])

        # Creating unique constraint on 'MailingListProject', fields
        # ['project', 'mailing_list']
        db.create_unique(u'mlinfo_mailinglistproject',
                         ['project_id', 'mailing_list_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'MailingListProject', fields
        # ['project', 'mailing_list']
        db.delete_unique(u'mlinfo_mailinglistproject',
                         ['project_id', 'mailing_list_id'])

        # Renaming model 'MailingListProject'
        db.rename_table(u'mlinfo_mailinglistproject',
                        u'hmeter_frontend_mailinglistproject')
        db.send_create_signal(u'mlinfo', ['MailingListProject'])

        # Creating unique constraint on 'MailingListProject',
        # fields ['project', 'mailing_list']
        db.create_unique(u'hmeter_frontend_mailinglistproject',
                         ['project_id', 'mailing_list_id'])
