...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BugTrackerProject', fields ['project']
        db.delete_unique('healthmeter_bugtrackerproject', ['project_id'])

        # Adding unique constraint on 'BugTrackerProject', fields ['project', 'bug_tracker', 'product', 'component']
        db.create_unique('healthmeter_bugtrackerproject', ['project_id', 'bug_tracker_id', 'product', 'component'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BugTrackerProject', fields ['project', 'bug_tracker', 'product', 'component']
        db.delete_unique('healthmeter_bugtrackerproject', ['project_id', 'bug_tracker_id', 'product', 'component'])

        # Adding unique constraint on 'BugTrackerProject', fields ['project']
        db.create_unique('healthmeter_bugtrackerproject', ['project_id'])
