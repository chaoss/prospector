...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hmeter_frontend_options', (
            ...
            ('highlight_domain', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['participantinfo.EmailDomain'], null=True)),
        ))
        db.send_create_signal('hmeter_frontend', ['Options'])


    def backwards(self, orm):
        # Deleting model 'Options'
        db.delete_table('hmeter_frontend_options')
    ...
    models = {
        ...
        'hmeter_frontend.options': {
            'Meta': {'object_name': 'Options', '_ormbases': ['preferences.Preferences']},
            'highlight_domain': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['participantinfo.EmailDomain']", 'null': 'True'}),
