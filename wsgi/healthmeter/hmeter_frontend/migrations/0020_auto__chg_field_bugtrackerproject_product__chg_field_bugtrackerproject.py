...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BugTrackerProject.product'
        db.alter_column('healthmeter_bugtrackerproject', 'product', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'BugTrackerProject.component'
        db.alter_column('healthmeter_bugtrackerproject', 'component', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'BugTrackerProject.product'
        db.alter_column('healthmeter_bugtrackerproject', 'product', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'BugTrackerProject.component'
        db.alter_column('healthmeter_bugtrackerproject', 'component', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
