...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Metric.sibling_order'
        db.add_column('hmeter_frontend_metric', 'sibling_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Metric.sibling_order'
        db.delete_column('hmeter_frontend_metric', 'sibling_order')
