...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.last_updated'
        db.add_column('hmeter_frontend_blog', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'IrcChannel.last_updated'
        db.add_column('hmeter_frontend_ircchannel', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.last_updated'
        db.delete_column('hmeter_frontend_blog', 'last_updated')

        # Deleting field 'IrcChannel.last_updated'
        db.delete_column('hmeter_frontend_ircchannel', 'last_updated')
