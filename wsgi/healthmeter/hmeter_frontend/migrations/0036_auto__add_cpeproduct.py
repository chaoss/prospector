...
class Migration(SchemaMigration):
    depends_on = (('cveinfo', '0001_initial.py'),)

    def forwards(self, orm):
        # Adding model 'CPEProduct'
        db.create_table('hmeter_frontend_cpeproduct', (
            ('product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cveinfo.Product'], unique=True, primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projectinfo.Project'])),
        ))
        db.send_create_signal('hmeter_frontend', ['CPEProduct'])


    def backwards(self, orm):
        # Deleting model 'CPEProduct'
        db.delete_table('hmeter_frontend_cpeproduct')
