...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'MailingListPurpose', fields ['name']
        db.create_unique('hmeter_frontend_mailinglistpurpose', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'MailingListPurpose', fields ['name']
        db.delete_unique('hmeter_frontend_mailinglistpurpose', ['name'])
