...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BlogPost', fields ['blog', 'guid']
        db.create_unique('hmeter_frontend_blogpost', ['blog_id', 'guid'])


    def backwards(self, orm):
        # Removing unique constraint on 'BlogPost', fields ['blog', 'guid']
        db.delete_unique('hmeter_frontend_blogpost', ['blog_id', 'guid'])
