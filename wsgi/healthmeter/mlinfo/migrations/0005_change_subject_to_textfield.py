...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mlinfo_post', 'subject', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Post.subject'
        db.alter_column('mlinfo_post', 'subject', self.gf('django.db.models.fields.CharField')(max_length=300))
